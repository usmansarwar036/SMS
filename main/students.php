...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Active Students
			<a style=" margin-right: 139px; float: right;"  title="Click to go to deactive Student" href="deactive_student.php"><button class="btn btn-primary btn-large"> Deactive Students</button> </a>
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM students where status = 'active' and class != 'Free intenship'  and class != 'Paid intenship' ");
				$result->execute();
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM students where status = 'active' and class != 'Free intenship' and class != 'Paid intenship' order by sr desc ");
				$result->execute();
		...
		<!--	<a  href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Delete</button></a>  -->
			<a  title="Click to deactive the Student" href="save_deactive_student.php?id=<?php echo $row['sr']; ?>"><button class="btn btn-primary btn-mini"><i class="icon-ok"></i> Deactive</button> </a>
		</td>
			</tr>
			<?php
				}
