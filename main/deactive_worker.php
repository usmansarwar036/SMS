...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Deactive Worker
			<a style=" margin-right: 139px; float: right;"  title="Click to go to deactive Student" href="worker.php"><button class="btn btn-primary btn-large"> Active Worker</button> </a>
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active">Woker</li>
			</ul>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM students where status = 'deactive' and class = 'Paid intenship' ");
				$result->execute();
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td>
			<a  title="Click to active the Student" href="save_active_worker.php?id=<?php echo $row['sr']; ?>"><button class="btn btn-primary btn-mini"><i class="icon-ok"></i> Active</button> </a>
		</td>
			</tr>
			<?php
				}
