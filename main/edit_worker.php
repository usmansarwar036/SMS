...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Edit Worker
			</div>
			<ul class="breadcrumb">
...
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="save_edit_worker.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i> Edit Worker</h4></center>
<hr>
...
<select style="display: none;" name="class" id="class"  required style='width: 265px; height:auto;' >
...
<span>Skills: </span><input type="text" style="width:265px; height:30px;" value="<?php echo $row['old_class']; ?>" name="old_class"  /><br>
<span>Percentage: </span><input type="text" style="width:265px; height:30px;" value="<?php echo $row['monthly_fee']; ?>" name="monthly_fee"  /><br>
<span>Join Date: </span><input type="date" style="width:265px; height:30px;" value="<?php echo $row['adm_date']; ?>" name="adm_date" required /><br>
<span>Left Date: </span><input type="date" style="width:265px; height:30px;" value="<?php echo $row['end_date']; ?>" name="end_date"  /><br>
<span>Phone : </span><input type="number" style="width:265px; height:30px;" value="<?php echo $row['cell']; ?>" name="cell"  /><br>
<input style="display: none;" type="number" style="width:265px; height:30px;" value="<?php echo $row['fee']; ?>" name="fee"  />
<input style="display: none;" type="number" style="width:265px; height:30px;" value="<?php echo $row['m_fee']; ?>" name="m_fee"  />
