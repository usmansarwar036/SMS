...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Add Trainee
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><form action="save_intership.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i> Add New Trainee	</h4></center>
<hr><center>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Trainee Reg.No: </span><input type="text" style="width:265px; height:30px;"  value="ET22-<?php 
...
<button class="btn btn-success btn-block btn-large" type="submit" style="width:267px;"><i class="icon icon-save icon-large"></i> Save Trainee</button>
</div>
</div>
</form>
</center>
