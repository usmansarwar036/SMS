...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Add Worker
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><form action="save_worker.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i> Add New Worker	</h4></center>
<hr><center>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Internie Reg.No: </span><input type="text" style="width:265px; height:30px;"  value="ET22-<?php 
$prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,4));?>" name='student_id' Required /><br>
...
<span>Joining Date: </span><input type	="date" style="width:265px; height:30px;" name="adm_date" required /><br>

<span>Cell: </span><input type	="number" style="width:265px; height:30px;" name="cell" required /><br>
<span>Skill: </span><input type	="text" style="width:265px; height:30px;" name="skill" required /><br>
<span>Percentage: </span><input type	="text" style="width:265px; height:30px;" name="monthly_fee" required /><br>
...
<button class="btn btn-success btn-block btn-large" type="submit" style="width:267px;"><i class="icon icon-save icon-large"></i> Save Student</button>
</div>
</div>
</form>
</center>
